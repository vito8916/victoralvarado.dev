...
<button style={{color: "#fff", backgroundColor: "#03a651", fontWeight: 500, fontSize: ".875rem", padding: "0 .5rem", alignItems: "center", marginRight: ".5rem", marginBottom: "2rem", outline: "none"}}>
