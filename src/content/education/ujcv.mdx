...
description: Bachelor degree with strong foundation in programming, databases, systems analysis, software architecture fundamentals, and project planning. This stage shaped my problem-solving approach and my ability to connect technical execution with business needs.
tags:
    - university
    - studies
    - programming
