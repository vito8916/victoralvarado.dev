---
title: Modernizing platforms and operations at Network Specialist Pro's
position: Senior Full-Stack Engineer
location: Remote, USA
date: 2020-03-10
endDate: 2024-12-12
company: Network Specialist Pro's
description: Led full-stack delivery across internal operations and customer-facing systems.
bullets:
    - Designed and built a centralized back-office platform to manage 3,000+ active subscriptions from one place.
    - Integrated multiple services and APIs to automate report generation and reduce manual operations.
    - Reduced Excel dependency by 40% by standardizing reporting workflows and dashboards.
    - Modernized UI across 2 landing pages and 3 internal platforms to improve usability and consistency.
    - Delivered stable, production-ready features in close collaboration with leadership and operations teams.
tags:
    - PHP
    - React
    - Yii2
...
<div className={"badge-container"} style={{display:"flex;", gap:".5rem", alignItems:"center", overflowX:"scroll"}}>
